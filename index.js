...
export const PrivateAccountV3Api = $root.PrivateAccountV3Api = (() => {
    ...
    PrivateAccountV3Api.decode = function decode(reader, length, error) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PrivateAccountV3Api();
    ...
    PrivateAccountV3Api.fromObject = function fromObject(object) {
        if (object instanceof $root.PrivateAccountV3Api)
            return object;
        let message = new $root.PrivateAccountV3Api();
...
export const PrivateDealsV3Api = $root.PrivateDealsV3Api = (() => {
    ...
    PrivateDealsV3Api.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PrivateDealsV3Api();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PrivateDealsV3Api.fromObject = function fromObject(object) {
        if (object instanceof $root.PrivateDealsV3Api)
            return object;
        let message = new $root.PrivateDealsV3Api();
...
export const PrivateOrdersV3Api = $root.PrivateOrdersV3Api = (() => {
    ...
    PrivateOrdersV3Api.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PrivateOrdersV3Api();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PrivateOrdersV3Api.fromObject = function fromObject(object) {
        if (object instanceof $root.PrivateOrdersV3Api)
            return object;
        let message = new $root.PrivateOrdersV3Api();
        if (object.id != null)
...
export const PublicAggreBookTickerV3Api = $root.PublicAggreBookTickerV3Api = (() => {
    ...
    PublicAggreBookTickerV3Api.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicAggreBookTickerV3Api();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicAggreBookTickerV3Api.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicAggreBookTickerV3Api)
            return object;
        let message = new $root.PublicAggreBookTickerV3Api();
...
export const PublicAggreDealsV3Api = $root.PublicAggreDealsV3Api = (() => {
    ...
    PublicAggreDealsV3Api.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicAggreDealsV3Api();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicAggreDealsV3Api.verify = function verify(message) {
        ...
        if (message.deals != null && message.hasOwnProperty("deals")) {
            ...
            for (let i = 0; i < message.deals.length; ++i) {
                let error = $root.PublicAggreDealsV3ApiItem.verify(message.deals[i]);
                if (error)
                    return "deals." + error;
            }
        }
    ...
    PublicAggreDealsV3Api.toObject = function toObject(message, options) {
        ...
        if (message.deals && message.deals.length) {
            object.deals = [];
            for (let j = 0; j < message.deals.length; ++j)
...
export const PublicAggreDealsV3ApiItem = $root.PublicAggreDealsV3ApiItem = (() => {
    ...
    PublicAggreDealsV3ApiItem.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicAggreDealsV3ApiItem();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicAggreDealsV3ApiItem.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicAggreDealsV3ApiItem)
            return object;
        let message = new $root.PublicAggreDealsV3ApiItem();
        if (object.price != null)
            message.price = String(object.price);
        if (object.quantity != null)
            message.quantity = String(object.quantity);
...
export const PublicAggreDepthsV3Api = $root.PublicAggreDepthsV3Api = (() => {
    ...
    PublicAggreDepthsV3Api.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicAggreDepthsV3Api();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicAggreDepthsV3Api.verify = function verify(message) {
        ...
        if (message.asks != null && message.hasOwnProperty("asks")) {
            ...
            for (let i = 0; i < message.asks.length; ++i) {
                let error = $root.PublicAggreDepthV3ApiItem.verify(message.asks[i]);
                if (error)
                    return "asks." + error;
            }
        }
        if (message.bids != null && message.hasOwnProperty("bids")) {
            ...
            for (let i = 0; i < message.bids.length; ++i) {
                let error = $root.PublicAggreDepthV3ApiItem.verify(message.bids[i]);
                if (error)
                    return "bids." + error;
            }
        }
    ...
    PublicAggreDepthsV3Api.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicAggreDepthsV3Api)
            return object;
        let message = new $root.PublicAggreDepthsV3Api();
        if (object.asks) {
...
export const PublicAggreDepthV3ApiItem = $root.PublicAggreDepthV3ApiItem = (() => {
    ...
    PublicAggreDepthV3ApiItem.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicAggreDepthV3ApiItem();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicAggreDepthV3ApiItem.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicAggreDepthV3ApiItem)
            return object;
        let message = new $root.PublicAggreDepthV3ApiItem();
        if (object.price != null)
            message.price = String(object.price);
        if (object.quantity != null)
            message.quantity = String(object.quantity);
...
export const PublicBookTickerBatchV3Api = $root.PublicBookTickerBatchV3Api = (() => {
    ...
    PublicBookTickerBatchV3Api.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicBookTickerBatchV3Api();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicBookTickerBatchV3Api.verify = function verify(message) {
        ...
        if (message.items != null && message.hasOwnProperty("items")) {
            ...
            for (let i = 0; i < message.items.length; ++i) {
                let error = $root.PublicBookTickerV3Api.verify(message.items[i]);
                if (error)
                    return "items." + error;
            }
        }
    ...
    PublicBookTickerBatchV3Api.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicBookTickerBatchV3Api)
            return object;
        let message = new $root.PublicBookTickerBatchV3Api();
        if (object.items) {
...
export const PublicBookTickerV3Api = $root.PublicBookTickerV3Api = (() => {
    ...
    PublicBookTickerV3Api.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicBookTickerV3Api();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicBookTickerV3Api.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicBookTickerV3Api)
            return object;
        let message = new $root.PublicBookTickerV3Api();
        if (object.bidPrice != null)
            message.bidPrice = String(object.bidPrice);
        if (object.bidQuantity != null)
            message.bidQuantity = String(object.bidQuantity);
...
export const PublicDealsV3Api = $root.PublicDealsV3Api = (() => {
    ...
    PublicDealsV3Api.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicDealsV3Api();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicDealsV3Api.verify = function verify(message) {
        ...
        if (message.deals != null && message.hasOwnProperty("deals")) {
            if (!Array.isArray(message.deals))
                return "deals: array expected";
            for (let i = 0; i < message.deals.length; ++i) {
                let error = $root.PublicDealsV3ApiItem.verify(message.deals[i]);
                if (error)
                    return "deals." + error;
            }
        }
    ...
    PublicDealsV3Api.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicDealsV3Api)
            return object;
        let message = new $root.PublicDealsV3Api();
        if (object.deals) {
            if (!Array.isArray(object.deals))
...
export const PublicDealsV3ApiItem = $root.PublicDealsV3ApiItem = (() => {
    ...
    PublicDealsV3ApiItem.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicDealsV3ApiItem();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicDealsV3ApiItem.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicDealsV3ApiItem)
            return object;
        let message = new $root.PublicDealsV3ApiItem();
        if (object.price != null)
            message.price = String(object.price);
        if (object.quantity != null)
            message.quantity = String(object.quantity);
...
export const PublicIncreaseDepthsBatchV3Api = $root.PublicIncreaseDepthsBatchV3Api = (() => {
    ...
    PublicIncreaseDepthsBatchV3Api.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicIncreaseDepthsBatchV3Api();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicIncreaseDepthsBatchV3Api.verify = function verify(message) {
        ...
        if (message.items != null && message.hasOwnProperty("items")) {
            if (!Array.isArray(message.items))
                return "items: array expected";
            for (let i = 0; i < message.items.length; ++i) {
                let error = $root.PublicIncreaseDepthsV3Api.verify(message.items[i]);
                if (error)
                    return "items." + error;
            }
        }
    ...
    PublicIncreaseDepthsBatchV3Api.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicIncreaseDepthsBatchV3Api)
            return object;
        let message = new $root.PublicIncreaseDepthsBatchV3Api();
        if (object.items) {
            if (!Array.isArray(object.items))
...
export const PublicIncreaseDepthsV3Api = $root.PublicIncreaseDepthsV3Api = (() => {
    ...
    PublicIncreaseDepthsV3Api.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicIncreaseDepthsV3Api();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicIncreaseDepthsV3Api.verify = function verify(message) {
        ...
        if (message.asks != null && message.hasOwnProperty("asks")) {
            if (!Array.isArray(message.asks))
                return "asks: array expected";
            for (let i = 0; i < message.asks.length; ++i) {
                let error = $root.PublicIncreaseDepthV3ApiItem.verify(message.asks[i]);
                if (error)
                    return "asks." + error;
            }
        }
        if (message.bids != null && message.hasOwnProperty("bids")) {
            if (!Array.isArray(message.bids))
                return "bids: array expected";
            for (let i = 0; i < message.bids.length; ++i) {
                let error = $root.PublicIncreaseDepthV3ApiItem.verify(message.bids[i]);
                if (error)
                    return "bids." + error;
            }
        }
    ...
    PublicIncreaseDepthsV3Api.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicIncreaseDepthsV3Api)
            return object;
        let message = new $root.PublicIncreaseDepthsV3Api();
        if (object.asks) {
            if (!Array.isArray(object.asks))
...
export const PublicIncreaseDepthV3ApiItem = $root.PublicIncreaseDepthV3ApiItem = (() => {
    ...
    PublicIncreaseDepthV3ApiItem.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicIncreaseDepthV3ApiItem();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicIncreaseDepthV3ApiItem.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicIncreaseDepthV3ApiItem)
            return object;
        let message = new $root.PublicIncreaseDepthV3ApiItem();
        if (object.price != null)
            message.price = String(object.price);
        if (object.quantity != null)
            message.quantity = String(object.quantity);
...
export const PublicLimitDepthsV3Api = $root.PublicLimitDepthsV3Api = (() => {
    ...
    PublicLimitDepthsV3Api.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicLimitDepthsV3Api();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicLimitDepthsV3Api.verify = function verify(message) {
        ...
        if (message.asks != null && message.hasOwnProperty("asks")) {
            if (!Array.isArray(message.asks))
                return "asks: array expected";
            for (let i = 0; i < message.asks.length; ++i) {
                let error = $root.PublicLimitDepthV3ApiItem.verify(message.asks[i]);
                if (error)
                    return "asks." + error;
            }
        }
        if (message.bids != null && message.hasOwnProperty("bids")) {
            if (!Array.isArray(message.bids))
                return "bids: array expected";
            for (let i = 0; i < message.bids.length; ++i) {
                let error = $root.PublicLimitDepthV3ApiItem.verify(message.bids[i]);
                if (error)
                    return "bids." + error;
            }
        }
    ...
    PublicLimitDepthsV3Api.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicLimitDepthsV3Api)
            return object;
        let message = new $root.PublicLimitDepthsV3Api();
        if (object.asks) {
            if (!Array.isArray(object.asks))
...
export const PublicLimitDepthV3ApiItem = $root.PublicLimitDepthV3ApiItem = (() => {
    ...
    PublicLimitDepthV3ApiItem.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicLimitDepthV3ApiItem();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicLimitDepthV3ApiItem.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicLimitDepthV3ApiItem)
            return object;
        let message = new $root.PublicLimitDepthV3ApiItem();
        if (object.price != null)
            message.price = String(object.price);
        if (object.quantity != null)
            message.quantity = String(object.quantity);
...
export const PublicMiniTickerV3Api = $root.PublicMiniTickerV3Api = (() => {
    ...
    PublicMiniTickerV3Api.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicMiniTickerV3Api();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicMiniTickerV3Api.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicMiniTickerV3Api)
            return object;
        let message = new $root.PublicMiniTickerV3Api();
...
export const PublicMiniTickersV3Api = $root.PublicMiniTickersV3Api = (() => {
    ...
    PublicMiniTickersV3Api.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicMiniTickersV3Api();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicMiniTickersV3Api.verify = function verify(message) {
        ...
        if (message.items != null && message.hasOwnProperty("items")) {
            if (!Array.isArray(message.items))
                return "items: array expected";
            for (let i = 0; i < message.items.length; ++i) {
                let error = $root.PublicMiniTickerV3Api.verify(message.items[i]);
                if (error)
                    return "items." + error;
            }
        }
    ...
    PublicMiniTickersV3Api.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicMiniTickersV3Api)
            return object;
        let message = new $root.PublicMiniTickersV3Api();
        if (object.items) {
            if (!Array.isArray(object.items))
...
export const PublicSpotKlineV3Api = $root.PublicSpotKlineV3Api = (() => {
    ...
    PublicSpotKlineV3Api.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PublicSpotKlineV3Api();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PublicSpotKlineV3Api.fromObject = function fromObject(object) {
        if (object instanceof $root.PublicSpotKlineV3Api)
            return object;
        let message = new $root.PublicSpotKlineV3Api();
...
export const PushDataV3ApiWrapper = $root.PushDataV3ApiWrapper = (() => {
    ...
    PushDataV3ApiWrapper.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PushDataV3ApiWrapper();
        while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error)
                break;
    ...
    PushDataV3ApiWrapper.verify = function verify(message) {
        ...
        if (message.publicDeals != null && message.hasOwnProperty("publicDeals")) {
            properties.body = 1;
            {
                let error = $root.PublicDealsV3Api.verify(message.publicDeals);
                if (error)
        ...
        if (message.publicIncreaseDepths != null && message.hasOwnProperty("publicIncreaseDepths")) {
            ...
            properties.body = 1;
            {
                let error = $root.PublicIncreaseDepthsV3Api.verify(message.publicIncreaseDepths);
                if (error)
        ...
        if (message.publicLimitDepths != null && message.hasOwnProperty("publicLimitDepths")) {
            ...
            properties.body = 1;
            {
                let error = $root.PublicLimitDepthsV3Api.verify(message.publicLimitDepths);
                if (error)
        ...
        if (message.privateOrders != null && message.hasOwnProperty("privateOrders")) {
            ...
            properties.body = 1;
            {
                let error = $root.PrivateOrdersV3Api.verify(message.privateOrders);
                if (error)
        ...
        if (message.publicBookTicker != null && message.hasOwnProperty("publicBookTicker")) {
            ...
            properties.body = 1;
            {
                let error = $root.PublicBookTickerV3Api.verify(message.publicBookTicker);
                if (error)
        ...
        if (message.privateDeals != null && message.hasOwnProperty("privateDeals")) {
            ...
            properties.body = 1;
            {
                let error = $root.PrivateDealsV3Api.verify(message.privateDeals);
                if (error)
        ...
        if (message.privateAccount != null && message.hasOwnProperty("privateAccount")) {
            ...
            properties.body = 1;
            {
                let error = $root.PrivateAccountV3Api.verify(message.privateAccount);
                if (error)
        ...
        if (message.publicSpotKline != null && message.hasOwnProperty("publicSpotKline")) {
            ...
            properties.body = 1;
            {
                let error = $root.PublicSpotKlineV3Api.verify(message.publicSpotKline);
                if (error)
        ...
        if (message.publicMiniTicker != null && message.hasOwnProperty("publicMiniTicker")) {
            ...
            properties.body = 1;
            {
                let error = $root.PublicMiniTickerV3Api.verify(message.publicMiniTicker);
                if (error)
        ...
        if (message.publicMiniTickers != null && message.hasOwnProperty("publicMiniTickers")) {
            ...
            properties.body = 1;
            {
                let error = $root.PublicMiniTickersV3Api.verify(message.publicMiniTickers);
                if (error)
        ...
        if (message.publicBookTickerBatch != null && message.hasOwnProperty("publicBookTickerBatch")) {
            ...
            properties.body = 1;
            {
                let error = $root.PublicBookTickerBatchV3Api.verify(message.publicBookTickerBatch);
                if (error)
        ...
        if (message.publicIncreaseDepthsBatch != null && message.hasOwnProperty("publicIncreaseDepthsBatch")) {
            ...
            properties.body = 1;
            {
                let error = $root.PublicIncreaseDepthsBatchV3Api.verify(message.publicIncreaseDepthsBatch);
                if (error)
        ...
        if (message.publicAggreDepths != null && message.hasOwnProperty("publicAggreDepths")) {
            ...
            properties.body = 1;
            {
                let error = $root.PublicAggreDepthsV3Api.verify(message.publicAggreDepths);
                if (error)
        ...
        if (message.publicAggreDeals != null && message.hasOwnProperty("publicAggreDeals")) {
            ...
            properties.body = 1;
            {
                let error = $root.PublicAggreDealsV3Api.verify(message.publicAggreDeals);
                if (error)
        ...
        if (message.publicAggreBookTicker != null && message.hasOwnProperty("publicAggreBookTicker")) {
            ...
            properties.body = 1;
            {
                let error = $root.PublicAggreBookTickerV3Api.verify(message.publicAggreBookTicker);
                if (error)
    ...
    PushDataV3ApiWrapper.fromObject = function fromObject(object) {
        if (object instanceof $root.PushDataV3ApiWrapper)
            return object;
        let message = new $root.PushDataV3ApiWrapper();
